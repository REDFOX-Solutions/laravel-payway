    ...
    <div
        ...
        <div
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('task_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/tasks*") ? "sidebar-nav-active" : "sidebar-nav" }}"
                ...
                <li class="items-center">
                    <a href="{{ route("admin.plan.index") }}"
                       class="{{ request()->is("admin/plan*") ? "sidebar-nav-active" : "sidebar-nav" }}">
                        <i class="fa-fw c-sidebar-nav-icon fas fa-user-circle"></i>
                        My Plan
                    </a>
                </li>
                ...
                <li class="items-center">
                    <a href="{{ route("admin.card.index") }}"
                       class="{{ request()->is("admin/card*") ? "sidebar-nav-active" : "sidebar-nav" }}">
                        <i class="fa-fw c-sidebar-nav-icon fas fa-credit-card"></i>
                        My Card
                    </a>
                </li>
